...
const About = () => {
  ...
  const skills = ['TypeScript', 'React', 'React Native', 'Node.js', 'ASP.NET', 'Ruby on Rails'];
      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              I've also worked on a bunch of projects from design to deployment, continuously
